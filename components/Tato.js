      ...
      <div className="flex flex-row-reverse md:flex-col-reverse w-full px-5">
        ...
        <div className="flex flex-col justify-center  items-center w-1/2 md:w-full">
          ...
          <p className="text-right  text-md sm:text-sm sm:leading-loose py-4 md:text-center text-gray-600 px-6 leading-loose">
            دستگاه لیزر کیوسوئیچ پیکوشور بعنوان نسل جدید دستگاه‌های لیزر جهت پاک
            کردن تاتو‌های ناخواسته معرفی شده است. این دستگاه با مدل در بازار
            شناخته می‌شود. علت محبوبیت و استقبال بالای پزشکان و بیماران از این
            دستگاه به کارگیری آخرین فناوری‌های لیزر کیوسوئیچ در آن است. به طوری
            که می‌توان ادعا کرد در حال حاضر پیشرفته‌ترین دستگاه برای حذف لیزر
            تاتو می‌باشد{" "}
          </p>
        </div>
      </div>
