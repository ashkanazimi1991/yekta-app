...
const Team = () => {
  return (
    <div className=' w-full    '>
       ...
       {/* <!-- component --> */}
<div>
            <div className="container px-10 mt-24  py-2 ">
                <h1 className="text-md  text-center text-gray-500 
                lg:text-md whitespace-nowrap">همکاران کلنیک یکتا</h1>
                ...
                <div className="grid grid-cols-3 min gap-8  px-[5%] mt-8 xl:mt-16 md:grid-cols-2
                 ...
                 sm:grid-cols-1">
                    ...
                    {/* ......................................... */}
                    <div className="flex flex-col bg-[#a221b36e]  justify-center items-center transition-colors
                     duration-200 py-10
