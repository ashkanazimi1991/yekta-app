      ...
      <div className='flex md:flex-col-reverse w-full px-5'>
        ...
        <div className='flex flex-col justify-center  items-center w-1/2 md:w-full'>
          <div className='flex justify-center items-center'>
            <div>
              <p className='text-2xl text-center w-full py-2 px-6 text-gray-200  font-bold pt-4'>بخش جوانسازی و لیفتینگ </p>
              <p className='text-xl text-center w-full py-2 px-6 text-gray-200   pt-4'>4D Ultra Hifu</p>
