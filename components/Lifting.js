      ...
      <div className="flex md:flex-col-reverse w-full px-5">
        ...
        <div className="flex flex-col justify-center  items-center w-1/2 md:w-full">
          ...
          <p className="text-right text-md sm:text-sm sm:leading-loose py-4 md:text-center text-gray-600 px-6 leading-loose">
            دستگاه هایفو چهار بعدی جدیدترین مدل هایفو می باشد که برای جوانسازی و
            لیفتینگ پوست استفاده می شود و بالا برنده سطح کلاژن سازی پوست است.
            این دستگاه برای حذف چین و چروک، کک و مک و آکنه، خط خنده و اخم کاربرد
            بسیار زیادی دارد. دستگاه هایفو 4 بعدی کاملاً غیر تهاجمی و بی خطر است
            و دارای تاییدیه های FDA آمریکا و CE اروپا می باشد.{" "}
          </p>
        </div>
      </div>
