...
const HeroAbout = () => {
  return (
    <div className=" min-h-screen space-y-12 bg-[#f0f0f000]  flex flex-col w-full justify-center items-center ">
      <div className="flex flex-row-reverse w-full  h-screen">
        <div className="w-1/2 absolute right-0 z-10 h-screen  py-10 backdrop-blur-md  bg-[#18544e8a] flex px-[10%] justify-center items-center flex-col">
          ...
          <div className="flex flex-col justify-center items-center">
            <img
              ...
              alt="کلینیک شقاقی"
            />
            <p className="text-white flex flex-col text-xl justify-center items-center">
              <span className=" whitespace-nowrap md:text-md">
                Dr Shaghaghi
              </span>
        ...
        <div className="w-full bg-[#f9f6ef32] min-h-screen  backdrop-blur-md">
          <ClinicSlider
            img1="/images/office02.jpg"
            img2="/images/10004.jpg"
