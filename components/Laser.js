      ...
      <div className="flex flex-row-reverse md:flex-col-reverse w-full px-5">
        ...
        <div className="flex flex-col justify-center  items-center w-1/2 md:w-full">
          <div className="flex justify-center items-center">
            <div>
              <p className="text-2xl text-center w-full py-2 px-6 text-gray-600  font-bold pt-4">
                بخش لیزر
              </p>

              <p className="text-xl text-center w-full py-2 px-6 text-gray-600   pt-4">
                Titanium Laser
              </p>
            </div>
            <img
          ...
          <p className="text-right text-md sm:text-sm sm:leading-loose py-4 md:text-center text-gray-600 px-6 leading-loose">
            دستگاه لیزر تیتانیوم یکی از کارآمدترین دستگاه های لیزر جهت رفع موهای
            ناخواسته بدن می باشد که از سه طول موج به طور همزمان استفاده می کند.
            البته این طول موج ها به عمق لایه های پوست تابانده می شوند و ریشه
            موهای زائد را مورد هدف قرار می دهند. این دستگاه به جدیدترین فناوری
            ها و تکنولوژی ها مجهز بوده و جزء پرفروش ترین و پرمصرف ترین دستگاه
            های موجود در صنعت زیبایی محسوب میشود
          </p>
        </div>
      </div>
