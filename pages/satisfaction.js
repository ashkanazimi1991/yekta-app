...
<div className='w-full px-5 py-24 flex flex-col justify-center items-center bg-gray-200 min-h-screen '>

<p className='text-gray-500 text-center py-6 '>نظرات مراجعه کنندگان  </p> 
    <div className='grid grid-cols-4 md:grid-cols-2  sm:grid-cols-1 w-ful gap-6 '>
      <div className='flex flex-col space-y-4 justify-center items-center bg-gray-100 p-10 shadow-xl w-full rounded-xl transition-all duration-500 ease-in-out hover:scale-110'>
